...
public partial class SkellParser : Parser {
	...
	public const int
		...
		RULE_expression = 11, RULE_eqExpr = 12, RULE_relExpr = 13, RULE_addExpr = 14, 
		RULE_mulExpr = 15, RULE_unary = 16, RULE_primary = 17, RULE_fnCall = 18, 
		RULE_fnArg = 19, RULE_term = 20, RULE_value = 21, RULE_bool = 22, RULE_array = 23, 
		RULE_pair = 24, RULE_object = 25, RULE_typeName = 26;
	public static readonly string[] ruleNames = {
		...
		"expression", "eqExpr", "relExpr", "addExpr", "mulExpr", "unary", "primary", 
		"fnCall", "fnArg", "term", "value", "bool", "array", "pair", "object", 
		"typeName"
	};
	...
	public ProgramContext program() {
		...
		try {
			...
			do {
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << EOL) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << KW_IF) | (1L << KW_FOR) | (1L << KW_LET) | (1L << LSQR) | (1L << LCURL) | (1L << LPAREN) | (1L << OP_NOT) | (1L << OP_SUB) | (1L << IDENTIFIER) | (1L << STRING) | (1L << NUMBER))) != 0) );
			}
		}
	...
	public IfControlContext ifControl() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 113; ifThenControl();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 114; ifThenElseControl();
				}
				break;
			}
		}
	...
	public IfThenControlContext ifThenControl() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 117; Match(KW_IF);
			State = 118; expression();
			State = 119; Match(KW_THEN);
	...
	public IfThenElseControlContext ifThenElseControl() {
		...
		try {
			...
			State = 123; Match(KW_ELSE);
			State = 126;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case LCURL:
				{
				State = 124; statementBlock();
				}
				break;
			case KW_IF:
				{
	...
	public ForControlContext forControl() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 128; Match(KW_FOR);
			State = 129; Match(IDENTIFIER);
			State = 130; Match(KW_IN);
	...
	public FnCallContext fnCall() {
		...
		EnterRule(_localctx, 36, RULE_fnCall);
		int _la;
		try {
			State = 200;
			ErrorHandler.Sync(this);
	...
	public ArrayContext array() {
		...
		try {
			...
			case 1:
				...
				State = 228; Match(RSQR);
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 230; Match(LSQR);
	...
	public ObjectContext @object() {
		...
		try {
			...
			case 1:
				...
				State = 247; Match(RCURL);
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 249; Match(LCURL);
	...
	public override bool Sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 17: return primary_sempred((PrimaryContext)_localctx, predIndex);
		}
		return true;
	}
	...
	private static char[] _serializedATN = {
		...
		'\x4', '\x3', '\x4', '\a', '\x4', 'J', '\n', '\x4', '\f', '\x4', '\xE', 
		'\x4', 'M', '\v', '\x4', '\x3', '\x4', '\x3', '\x4', '\x3', '\x5', '\x3', 
		'\x5', '\x3', '\x5', '\x3', '\x5', '\x3', '\x5', '\x3', '\x5', '\x3', 
		'\x5', '\x5', '\x5', 'X', '\n', '\x5', '\x5', '\x5', 'Z', '\n', '\x5', 
		'\x3', '\x6', '\x3', '\x6', '\x3', '\x6', '\x3', '\x6', '\x3', '\x6', 
		'\x3', '\x6', '\x3', '\x6', '\a', '\x6', '\x63', '\n', '\x6', '\f', '\x6', 
		'\xE', '\x6', '\x66', '\v', '\x6', '\x3', '\x6', '\x3', '\x6', '\x3', 
		'\x6', '\x5', '\x6', 'k', '\n', '\x6', '\x3', '\a', '\x3', '\a', '\x3', 
		'\a', '\x3', '\b', '\x3', '\b', '\x5', '\b', 'r', '\n', '\b', '\x3', '\t', 
		'\x3', '\t', '\x5', '\t', 'v', '\n', '\t', '\x3', '\n', '\x3', '\n', '\x3', 
		'\n', '\x3', '\n', '\x3', '\n', '\x3', '\v', '\x3', '\v', '\x3', '\v', 
		...
		'\r', '\x3', '\xE', '\x3', '\xE', '\x3', '\xE', '\x5', '\xE', '\x8E', 
		'\n', '\xE', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x5', '\xF', '\x93', 
		'\n', '\xF', '\x3', '\x10', '\x3', '\x10', '\x3', '\x10', '\a', '\x10', 
		'\x98', '\n', '\x10', '\f', '\x10', '\xE', '\x10', '\x9B', '\v', '\x10', 
		'\x3', '\x11', '\x3', '\x11', '\x3', '\x11', '\a', '\x11', '\xA0', '\n', 
		'\x11', '\f', '\x11', '\xE', '\x11', '\xA3', '\v', '\x11', '\x3', '\x12', 
		'\x3', '\x12', '\x3', '\x12', '\x5', '\x12', '\xA8', '\n', '\x12', '\x3', 
		'\x13', '\x3', '\x13', '\x3', '\x13', '\x3', '\x13', '\x3', '\x13', '\x3', 
		'\x13', '\x3', '\x13', '\x5', '\x13', '\xB1', '\n', '\x13', '\x3', '\x13', 
		'\x3', '\x13', '\x3', '\x13', '\x3', '\x13', '\a', '\x13', '\xB7', '\n', 
		'\x13', '\f', '\x13', '\xE', '\x13', '\xBA', '\v', '\x13', '\x3', '\x14', 
		'\x3', '\x14', '\x3', '\x14', '\x3', '\x14', '\x3', '\x14', '\x3', '\x14', 
		'\x3', '\x14', '\x3', '\x14', '\a', '\x14', '\xC4', '\n', '\x14', '\f', 
		'\x14', '\xE', '\x14', '\xC7', '\v', '\x14', '\x3', '\x14', '\x3', '\x14', 
		'\x5', '\x14', '\xCB', '\n', '\x14', '\x3', '\x15', '\x3', '\x15', '\x3', 
		'\x15', '\x3', '\x15', '\x3', '\x16', '\x3', '\x16', '\x5', '\x16', '\xD3', 
		'\n', '\x16', '\x3', '\x17', '\x3', '\x17', '\x3', '\x17', '\x3', '\x17', 
		'\x3', '\x17', '\x5', '\x17', '\xDA', '\n', '\x17', '\x3', '\x18', '\x3', 
		'\x18', '\x3', '\x19', '\x3', '\x19', '\x3', '\x19', '\x3', '\x19', '\a', 
		'\x19', '\xE2', '\n', '\x19', '\f', '\x19', '\xE', '\x19', '\xE5', '\v', 
		'\x19', '\x3', '\x19', '\x3', '\x19', '\x3', '\x19', '\x3', '\x19', '\x5', 
		'\x19', '\xEB', '\n', '\x19', '\x3', '\x1A', '\x3', '\x1A', '\x3', '\x1A', 
		'\x3', '\x1A', '\x3', '\x1B', '\x3', '\x1B', '\x3', '\x1B', '\x3', '\x1B', 
		'\a', '\x1B', '\xF5', '\n', '\x1B', '\f', '\x1B', '\xE', '\x1B', '\xF8', 
		'\v', '\x1B', '\x3', '\x1B', '\x3', '\x1B', '\x3', '\x1B', '\x3', '\x1B', 
		'\x5', '\x1B', '\xFE', '\n', '\x1B', '\x3', '\x1C', '\x3', '\x1C', '\x3', 
		'\x1C', '\
'\x3', '\x2', '\x2', '\x2', '\xA9', '\xAA', '\b', 
		'\x13', '\x1', '\x2', '\xAA', '\xB1', '\x5', '*', '\x16', '\x2', '\xAB', 
		'\xAC', '\a', '\x17', '\x2', '\x2', '\xAC', '\xAD', '\x5', '\x18', '\r', 
		'\x2', '\xAD', '\xAE', '\a', '\x18', '\x2', '\x2', '\xAE', '\xB1', '\x3', 
		'\x2', '\x2', '\x2', '\xAF', '\xB1', '\x5', '&', '\x14', '\x2', '\xB0', 
		'\xA9', '\x3', '\x2', '\x2', '\x2', '\xB0', '\xAB', '\x3', '\x2', '\x2', 
		'\x2', '\xB0', '\xAF', '\x3', '\x2', '\x2', '\x2', '\xB1', '\xB8', '\x3', 
		'\x2', '\x2', '\x2', '\xB2', '\xB3', '\f', '\x4', '\x2', '\x2', '\xB3', 
		'\xB4', '\a', '\x13', '\x2', '\x2', '\xB4', '\xB5', '\t', '\a', '\x2', 
		'\x2', '\xB5', '\xB7', '\a', '\x14', '\x2', '\x2', '\xB6', '\xB2', '\x3', 
		'\x2', '\x2', '\x2', '\xB7', '\xBA', '\x3', '\x2', '\x2', '\x2', '\xB8', 
		'\xB6', '\x3', '\x2', '\x2', '\x2', '\xB8', '\xB9', '\x3', '\x2', '\x2', 
		'\x2', '\xB9', '%', '\x3', '\x2', '\x2', '\x2', '\xBA', '\xB8', '\x3', 
		'\x2', '\x2', '\x2', '\xBB', '\xBC', '\a', ',', '\x2', '\x2', '\xBC', 
		'\xBD', '\a', '\x17', '\x2', '\x2', '\xBD', '\xCB', '\a', '\x18', '\x2', 
		'\x2', '\xBE', '\xBF', '\a', ',', '\x2', '\x2', '\xBF', '\xC0', '\a', 
		'\x17', '\x2', '\x2', '\xC0', '\xC5', '\x5', '(', '\x15', '\x2', '\xC1', 
		'\xC2', '\a', '\x1A', '\x2', '\x2', '\xC2', '\xC4', '\x5', '(', '\x15', 
		'\x2', '\xC3', '\xC1', '\x3', '\x2', '\x2', '\x2', '\xC4', '\xC7', '\x3', 
		'\x2', '\x2', '\x2', '\xC5', '\xC3', '\x3', '\x2', '\x2', '\x2', '\xC5', 
		'\xC6', '\x3', '\x2', '\x2', '\x2', '\xC6', '\xC8', '\x3', '\x2', '\x2', 
		'\x2', '\xC7', '\xC5', '\x3', '\x2', '\x2', '\x2', '\xC8', '\xC9', '\a', 
		'\x18', '\x2', '\x2', '\xC9', '\xCB', '\x3', '\x2', '\x2', '\x2', '\xCA', 
		'\xBB', '\x3', '\x2', '\x2', '\x2', '\xCA', '\xBE', '\x3', '\x2', '\x2', 
		'\x2', '\xCB', '\'', '\x3', '\x2', '\x2', '\x2', '\xCC', '\xCD', '\a', 
		',', '\x2', '\x2', '\xCD', '\xCE', '\a', '\x1C', '\x2', '\x2', '\xCE', 
		'\xCF', '\x5', '\x18', '\r', '\x2', '\xCF', ')', '\x3', '\x2', '\x2', 
		'\x2', '\xD0', '\xD3', '\x5', ',', '\x17', '\x2', '\xD1', '\xD3', '\a', 
		',', '\x2', '\x2', '\xD2', '\xD0', '\x3', '\x2', '\x2', '\x2', '\xD2', 
		'\xD1', '\x3', '\x2', '\x2', '\x2', '\xD3', '+', '\x3', '\x2', '\x2', 
		'\x2', '\xD4', '\xDA', '\x5', '\x34', '\x1B', '\x2', '\xD5', '\xDA', '\x5', 
		'\x30', '\x19', '\x2', '\xD6', '\xDA', '\a', '-', '\x2', '\x2', '\xD7', 
		'\xDA', '\a', '.', '\x2', '\x2', '\xD8', '\xDA', '\x5', '.', '\x18', '\x2', 
		'\xD9', '\xD4', '\x3', '\x2', '\x2', '\x2', '\xD9', '\xD5', '\x3', '\x2', 
		'\x2', '\x2', '\xD9', '\xD6', '\x3', '\x2', '\x2', '\x2', '\xD9', '\xD7', 
		'\x3', '\x2', '\x2', '\x2', '\xD9', '\xD8', '\x3', '\x2', '\x2', '\x2', 
		'\xDA', '-', '\x3', '\x2', '\x2', '\x2', '\xDB', '\xDC', '\t', '\b', '\x2', 
		'\x2', '\xDC', '/', '\x3', '\x2', '\x2', '\x2', '\xDD', '\xDE', '\a', 
		'\x13', '\x2', '\x2', '\xDE', '\xE3', '\x5', ',', '\x17', '\x2', '\xDF', 
		'\xE0', '\a', '\x1A', '\x2', '\x2', '\xE0', '\xE2', '\x5', ',', '\x17', 
		...
		'\x14', '\x2', '\x2', '\xE7', '\xEB', '\x3', '\x2', '\x2', '\x2', '\xE8', 
		'\xE9', '\a', '\x13', '\x2', '\x2', '\xE9', '\xEB', '\a', '\x14', '\x2', 
		'\x2', '\xEA', '\xDD', '\x3', '\x2', '\x2', '\x2', '\xEA', '\xE8', '\x3', 
		'\x2', '\x2', '\x2', '\xEB', '\x31', '\x3', '\x2', '\x2', '\x2', '\xEC', 
		'\xED', '\a', '-', '\x2', '\x2', '\xED', '\xEE', '\a', '\x1C', '\x2', 
		'\x2', '\xEE', '\xEF', '\x5', ',', '\x17', '\x2', '\xEF', '\x33', '\x3', 
		'\x2', '\x2', '\x2', '\xF0', '\xF1', '\a', '\x15', '\x2', '\x2', '\xF1', 
		'\xF6', '\x5', '\x32', '\x1A', '\x2', '\xF2', '\xF3', '\a', '\x1A', '\x2', 
		'\x2', '\xF3', '\xF5', '\x5', '\x32', '\x1A', '\x2', '\xF4', '\xF2', '\x3', 
		'\x2', '\x2', '\x2', '\xF5', '\xF8', '\x3', '\x2', '\x2', '\x2', '\xF6', 
		'\xF4', '\x3', '\x2', '\x2', '\x2', '\xF6', '\xF7', '\x3', '\x2', '\x2', 
		'\x2', '\xF7', '\xF9', '\x3', '\x2', '\x2', '\x2', '\xF8', '\xF6', '\x3', 
		'\x2', '\x2', '\x2', '\xF9', '\xFA', '\a', '\x16', '\x2', '\x2', '\xFA', 
		'\xFE', '\x3', '\x2', '\x2', '\x2', '\xFB', '\xFC', '\a', '\x15', '\x2', 
		'\x2', '\xFC', '\xFE', '\a', '\x16', '\x2', '\x2', '\xFD', '\xF0', '\x3', 
		'\x2', '\x2', '\x2', '\xFD', '\xFB', '\x3', '\x2', '\x2', '\x2', '\xFE', 
		'\x35', '\x3', '\x2', '\x2', '\x2', '\xFF', '\x100', '\t', '\t', '\x2', 
		'\x2', '\x100', '\x37', '\x3', '\x2', '\x2', '\x2', '\x1B', ';', '\x45', 
		'K', 'W', 'Y', '\x64', 'j', 'q', 'u', '\x80', '\x8D', '\x92', '\x99', 
		'\xA1', '\xA7', '\xB0', '\xB8', '\xC5', '\xCA', '\xD2', '\xD9', '\xE3', 
		'\xEA', '\xF6', '\xFD',
	};
